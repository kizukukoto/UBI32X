make_release:
	...
	@mv $(SOURCE)/$(BUILD_DIR)/release.img.seama $(SOURCE)/$(BUILD_DIR)/$(RELEASE_DIR)/wdn900_ip8k_xxxx.bin
	@echo  "  REMOVE    "/$(BUILD_DIR)/release.img
	@rm -f $(SOURCE)/$(BUILD_DIR)/release.img
	@echo  "  SEAMA     "/$(BUILD_DIR)/$(RELEASE_DIR)/wdn900_ip8k_xxxx.bin
	@$(SOURCE)/$(TOOLS_DIR)/bin/seama -d $(SOURCE)/$(BUILD_DIR)/$(RELEASE_DIR)/wdn900_ip8k_xxxx.bin $(DEBUG)
	@echo  "  CHECK     "/$(BUILD_DIR)/$(RELEASE_DIR)/wdn900_ip8k_xxxx.bin
	@[ -s $(SOURCE)/$(BUILD_DIR)/$(RELEASE_DIR)/wdn900_ip8k_xxxx.bin ] || { echo -e "\033[33m  LOG       Missing "/$(BUILD_DIR)/$(RELEASE_DIR)/wdn900_ip8k_xxxx.bin"\033[0m"; exit 1; }
	@echo -e "\033[32m  LOG       Image\033[0m"
	@echo  "  FILE      "/$(BUILD_DIR)/$(RELEASE_DIR)/wdn900_ip8k_xxxx.bin
