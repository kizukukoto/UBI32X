...
# installed.
TCL_PREFIX='/opt/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1_v02'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1_v02'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/leo/project/tmp/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1.build-v02/build/ubicom32toolchain/build/ubicom32-linux-uclibc/tcl/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1_v02/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1_v02/include'
...
# compiled.
TCL_SRC_DIR='/home/leo/project/tmp/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1.build-v02/build/ubicom32toolchain/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/opt/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1_v02/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/leo/project/tmp/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1.build-v02/build/ubicom32toolchain/build/ubicom32-linux-uclibc/tcl/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1_v02/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/leo/project/tmp/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1.build-v02/build/ubicom32toolchain/build/ubicom32-linux-uclibc/tcl/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/ubicom32_sdk32x_gcc-4.4.1_uclibc-0.9.30.1_v02/lib/libtclstub8.4${TCL_DBGX}.a'
